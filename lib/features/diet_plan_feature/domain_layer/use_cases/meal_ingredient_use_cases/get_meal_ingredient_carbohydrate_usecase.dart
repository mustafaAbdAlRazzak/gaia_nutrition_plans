...
class GetMealIngredientCarbohydrateUseCase {
  final MealIngredientRepositoryInterface repository;

  GetMealIngredientCarbohydrateUseCase(this.repository);

  Future<double> execute(MealIngredientEntity mealIngredient) async {
    return await repository.getMealIngredientCarbohydrate(mealIngredient);
  }
}
